...
Naturally, the physical/practial experiments could not be reproduced as part of this check of the computational reproducibility.
...
```{r}
file.copy("experimental-evaluation-ble-beacon/Qamaz-etal-2022_files/figure-gfm/unnamed-chunk-4-1.png", "figure4.png", overwrite = TRUE)
...
**Without access to the beacon hardware, it's not possible for me to fully evaluate this part of the research.**
...
## FIXME! Not sure what I can do now - FIXME!
