...
# manually add type, short papers submissions come later
submission_table$type <- "Full-paper submission"
...
```{r accepted_dasa_barplot_label, echo=FALSE}
...
review_data_figure <- review_data_figure_data  %>%
    ...
    labs(title = "AGILE 2022 Submissions: Transparency & Reproducibility",
