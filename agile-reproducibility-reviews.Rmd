---
title: "Reproducibility Review AGILE 2022"
author: "Daniel Nüst"
...
This document includes scripts and text analysis to support the reproducibility review at the [AGILE conference 2022](https://agile-online.org/conference-2022), which is organised by a team from Vilnius, Lithuania.
...
The code of this document is published on GitHub in the repository [reproducible-agile/reviews-2022](https://github.com/reproducible-agile/reviews-2022), where you can inspect the R code in the file `agile-reproducibility-reviews.Rmd` and find instructions for reproducing the workflow.
...
```{r wordstemcloud, dpi=150, echo=FALSE, fig.cap="Wordstem cloud of AGILE 2022 full paper submissions"}
...
The main outcome of the reviews is a _report_, which is published in individual OSF projects as components of the [OSF project for the reproducibility reviews 2022](https://osf.io/r5w79/).
...
2. Take a look at the [review report template](https://github.com/reproducible-agile/reviews-2022/blob/master/report-template/reproreview-template.Rmd) - even if you're not using it, it gives you guidance
3. Go to the [Discoure forum discussion for reproducibility reviewers](https://discourse.agile-online.org/c/repro-review-2022/8) and find your assignments
...
7. Add a new component to the [OSF project for 2022 reproducibility reviews](https://osf.io/r5w79/)
    - Use the European storage location, "Frankfurt"
    - Name the component `Reproducibility review of: <FULL PAPER TITLE>`
    - Add all contributors to the reproduction to the project (and remove possibly automatically added _"parent project contributors"_ from the [list of bibliographic contributors](https://help.osf.io/article/243-understand-contributor-permissions) because that would generate an incorrect citation statement on your project)
    - Add the to be expected DOI to your report: you can preprend `10.17605/OSF.IO/` to the identifier of your OSF project to get the DOI; stick to all upper case or all lower case for readability, but both work and resolve to the same project
...
I'm contacting you as the corresponding author of the paper "<TITLE>" submitted to AGILE 2022.
...
AGILE Reproducibility Committee Chair 2022
```
...
AGILE Reproducibility Committee 2022
```
...
congratulations to the acceptance of your submission "TITLE" as a full paper at the AGILE conference 2022.
